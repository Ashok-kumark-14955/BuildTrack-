...
db_1.default.prepare(`INSERT INTO projects (id, name, code, description, startDate, endDate, status, managerName, createdAt, updatedAt)
...
const insertMilestone = db_1.default.prepare(`INSERT INTO milestones (id, projectId, name, description, dueDate, status, createdAt, updatedAt)
   VALUES (?, ?, ?, ?, ?, ?, ?, ?)`);
...
const insertTask = db_1.default.prepare(`INSERT INTO tasks
   ...
   VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`);
const insertActivity = db_1.default.prepare('INSERT INTO activity (id, taskId, drawingId, message, createdAt) VALUES (?, ?, ?, ?, ?)');
const insertProjectTask = db_1.default.prepare(`INSERT INTO project_tasks
...
db_1.default.prepare(`INSERT INTO drawings (id, projectId, milestoneId, name, fileUrl, fileType, gridCols, gridRows, columnPositions, createdAt)
   VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).run(foundDrawingId, projectId, milestoneIds.m2, 'STR-FND-001 Basement Foundation Plan', writeSvg(foundationPlanSvg()), 'image', 6, 5, JSON.stringify(computeColumnPositions(['A', 'B', 'C', 'D', 'E', 'F'], [1, 2, 3, 4, 5], 200, 180, 220, 140)), projectNow);
...
db_1.default.prepare(`INSERT INTO drawings (id, projectId, milestoneId, name, fileUrl, fileType, gridCols, gridRows, columnPositions, createdAt)
   VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).run(colDrawingId, projectId, milestoneIds.m3, 'STR-COL-002 Steel Column Erection Plan', writeSvg(columnErectionSvg()), 'image', 6, 5, JSON.stringify(computeColumnPositions(['A', 'B', 'C', 'D', 'E', 'F'], [1, 2, 3, 4, 5], 200, 190, 220, 140)), projectNow);
const columnTasks = [
...
db_1.default.prepare(`INSERT INTO drawings (id, projectId, milestoneId, name, fileUrl, fileType, gridCols, gridRows, columnPositions, createdAt)
   VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).run(beamDrawingId, projectId, milestoneIds.m4, 'STR-BEA-003 Steel Beam Erection Plan', writeSvg(beamErectionSvg()), 'image', 6, 5, JSON.stringify(computeColumnPositions(['A', 'B', 'C', 'D', 'E', 'F'], [1, 2, 3, 4, 5], 200, 190, 220, 140)), projectNow);
const beamTasks = [
...
db_1.default.prepare(`INSERT INTO drawings (id, projectId, milestoneId, name, fileUrl, fileType, gridCols, gridRows, columnPositions, createdAt)
   VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).run(rafterDrawingId, projectId, milestoneIds.m5, 'STR-RAF-004 Steel Rafter Erection Plan', writeSvg(rafterErectionSvg()), 'image', 6, 5, JSON.stringify(computeColumnPositions(['A', 'B', 'C', 'D', 'E', 'F'], [1, 2, 3, 4, 5], 200, 200, 220, 130)), projectNow);
const rafterTasks = [
